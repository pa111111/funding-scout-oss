...
- **Backpack** — execution эмпирически плохой: "вроде комиссии те же что HL, но позиция выходит дороже". Один из стримящих систематиков перестал использовать. **Низкий приоритет в каталоге.**
